"""
Summary Prompt — Legal Document Summarization

Generates a structured, non-expert-friendly summary of legal documents
including parties, dates, obligations, and clause breakdowns.
"""
...
SUMMARY_TEMPLATE = """\
**Your Role:** You are an expert legal analyst AI. Your mission is to transform dense, complex legal documents into clear, actionable, and structured summaries for a non-expert user.
